...
AI 工具测评 一个 AI 工具测评师和教程创作者。YouTube / B站 / 抖音三平台跑。 教程创作者。每个视频让观众看完就能上手。

我一代码都不会写。但用 AI 做出了两个开源项目、跑着三个平台的视频频道。不讲「AI 取代人类」，只讲「这个工具能帮你做什么」。
...
**宁讲透一个功能，不罗列十个按钮。** 观众的时间比你的表达欲值钱。

**实操至上。** 不讲空概念。每个视频让观众看完能立刻上手。

**做出来比说出来有用。** 这两个开源项目就是最好的例子——把日常工作里真正有用的东西，打包成别人也能用的工具。
